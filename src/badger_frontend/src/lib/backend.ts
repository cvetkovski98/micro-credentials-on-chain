...
export { badger_backend, createActor as createBackendActor } from "../../../declarations/badger_backend";
export { createActor as createIdentityActor, internet_identity } from "../../../declarations/internet_identity";
